...
# --- FINAL, HIGH-ACCURACY SEISMIC ZONE DATA ---
SEISMIC_ZONES_GEOJSON = {
    "type": "FeatureCollection", "features": [
        {"type": "Feature", "properties": {"ZONE_ID": "III", "PGA": 0.36}, "geometry": {"type": "MultiPolygon", "coordinates": [
            [[[20.35, 38.50], [20.80, 38.00], [21.10, 38.45], [20.60, 38.65], [20.35, 38.50]]],
            [[[20.60, 38.85], [20.90, 38.55], [21.05, 38.70], [20.70, 38.95], [20.60, 38.85]]],
            [[[20.40, 39.40], [20.70, 39.15], [20.95, 39.30], [20.65, 39.75], [20.40, 39.40]]]
        ]}},
        {"type": "Feature", "properties": {"ZONE_ID": "II", "PGA": 0.24}, "geometry": {"type": "MultiPolygon", "coordinates": [
            [[[21.40, 38.10], [22.60, 37.95], [23.00, 38.25], [23.5, 38.4], [23.2, 38.7], [22.70, 38.45], [22.40, 38.25], [21.65, 38.45], [21.40, 38.10]]],
...
def get_geodata_for_coords(lat: float, lng: float):
    ...
    return {"success": success, "received_coords": {"latitude": lat, "longitude": lng}, "geotechnical": {"geologicalFormation": geological_formation}, "seismic": seismic_data}
